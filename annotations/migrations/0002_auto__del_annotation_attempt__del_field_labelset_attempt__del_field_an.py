...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'LabelSet.attempt'
        raise RuntimeError("Cannot reverse this migration. 'LabelSet.attempt' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'Annotation.attempt'
        raise RuntimeError("Cannot reverse this migration. 'Annotation.attempt' and its values cannot be restored.")

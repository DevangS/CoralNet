...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'LabelSet.attempt'
        db.delete_column('annotations_labelset', 'attempt_id')

        # Deleting field 'Annotation.attempt'
        db.delete_column('annotations_annotation', 'attempt_id')

        # Adding field 'Annotation.source'
        db.add_column('annotations_annotation', 'source', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['images.Source']), keep_default=False)

        # Changing field 'Annotation.annotation_date'
        db.alter_column('annotations_annotation', 'annotation_date', self.gf('django.db.models.fields.DateTimeField')())
    ...
    def backwards(self, orm):
        ...
        # Adding field 'LabelSet.attempt'
        db.add_column('annotations_labelset', 'attempt', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['annotations.annotation_attempt']), keep_default=False)

        # Adding field 'Annotation.attempt'
        db.add_column('annotations_annotation', 'attempt', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['annotations.annotation_attempt']), keep_default=False)

        # Deleting field 'Annotation.source'
        db.delete_column('annotations_annotation', 'source_id')

        # Changing field 'Annotation.annotation_date'
        db.alter_column('annotations_annotation', 'annotation_date', self.gf('django.db.models.fields.DateField')())
    ...
    models = {
        ...
        'annotations.annotation': {
            ...
            'annotation_date': ('django.db.models.fields.DateTimeField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

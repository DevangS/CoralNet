...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'AnnotationToolSettings.point_marker_size'
        db.add_column('annotations_annotationtoolsettings', 'point_marker_size', self.gf('django.db.models.fields.IntegerField')(default=16), keep_default=False)

        # Adding field 'AnnotationToolSettings.point_marker_is_scaled'
        db.add_column('annotations_annotationtoolsettings', 'point_marker_is_scaled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'AnnotationToolSettings.point_number_size'
        db.add_column('annotations_annotationtoolsettings', 'point_number_size', self.gf('django.db.models.fields.IntegerField')(default=24), keep_default=False)

        # Adding field 'AnnotationToolSettings.point_number_is_scaled'
        db.add_column('annotations_annotationtoolsettings', 'point_number_is_scaled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'AnnotationToolSettings.point_marker_size'
        db.delete_column('annotations_annotationtoolsettings', 'point_marker_size')

        # Deleting field 'AnnotationToolSettings.point_marker_is_scaled'
        db.delete_column('annotations_annotationtoolsettings', 'point_marker_is_scaled')

        # Deleting field 'AnnotationToolSettings.point_number_size'
        db.delete_column('annotations_annotationtoolsettings', 'point_number_size')

        # Deleting field 'AnnotationToolSettings.point_number_is_scaled'
        db.delete_column('annotations_annotationtoolsettings', 'point_number_is_scaled')
    ...
    models = {
        ...
        'annotations.annotationtoolsettings': {
            'Meta': {'object_name': 'AnnotationToolSettings'},
            'human_annotated_point_color': ('django.db.models.fields.CharField', [], {'default': "'8888FF'", 'max_length': '6'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'point_marker': ('django.db.models.fields.CharField', [], {'default': "'crosshair'", 'max_length': '30'}),
            'point_marker_is_scaled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'point_marker_size': ('django.db.models.fields.IntegerField', [], {'default': '16'}),
            'point_number_is_scaled': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'point_number_size': ('django.db.models.fields.IntegerField', [], {'default': '24'}),
            'robot_annotated_point_color': ('django.db.models.fields.CharField', [], {'default': "'FFFF00'", 'max_length': '6'}),
            'selected_point_color': ('django.db.models.fields.CharField', [], {'default': "'00FF00'", 'max_length': '6'}),
            'unannotated_point_color': ('django.db.models.fields.CharField', [], {'default': "'FFFF00'", 'max_length': '6'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'annotations.label': {
        ...
        'images.source': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'enable_robot_classifier': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnnotationToolSettings'
        db.create_table('annotations_annotationtoolsettings', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('point_marker', self.gf('django.db.models.fields.CharField')(default='crosshair', max_length=30)),
            ('unannotated_point_color', self.gf('django.db.models.fields.CharField')(default='FFFF00', max_length=6)),
            ('robot_annotated_point_color', self.gf('django.db.models.fields.CharField')(default='FFFF00', max_length=6)),
            ('human_annotated_point_color', self.gf('django.db.models.fields.CharField')(default='8888FF', max_length=6)),
            ('selected_point_color', self.gf('django.db.models.fields.CharField')(default='00FF00', max_length=6)),
        ))
        db.send_create_signal('annotations', ['AnnotationToolSettings'])


    def backwards(self, orm):
        
        # Deleting model 'AnnotationToolSettings'
        db.delete_table('annotations_annotationtoolsettings')

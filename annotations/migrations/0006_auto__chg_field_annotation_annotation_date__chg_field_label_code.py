...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('annotations_annotation', 'annotation_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Label.code'
        db.alter_column('annotations_label', 'code', self.gf('django.db.models.fields.CharField')(max_length=6))
    ...
    def backwards(self, orm):
        ...
        # BEWARE: MySQL will complain about data truncation if any label codes are 6 chars or more.
        # You need to shorten the labels to <= 5 chars before this migration will work.
        # (Alternatively, automate this by modifying this migration file:
        # include a line of code here that shortens the labels using South's API)
        db.alter_column('annotations_label', 'code', self.gf('django.db.models.fields.CharField')(max_length=5))

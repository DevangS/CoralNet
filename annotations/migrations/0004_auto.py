...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing M2M table for field labels on 'LabelSet'
        db.delete_table('annotations_labelset_labels')


    def backwards(self, orm):
        
        # Adding M2M table for field labels on 'LabelSet'
        db.create_table('annotations_labelset_labels', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('labelset', models.ForeignKey(orm['annotations.labelset'], null=False)),
            ('label', models.ForeignKey(orm['annotations.label'], null=False))
        ))
        db.create_unique('annotations_labelset_labels', ['labelset_id', 'label_id'])

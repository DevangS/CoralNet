...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'LabelSet.edit_date'
        db.add_column('annotations_labelset', 'edit_date', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.date(2011, 1, 1), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'LabelSet.edit_date'
        db.delete_column('annotations_labelset', 'edit_date')

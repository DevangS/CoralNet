...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AnnotationToolAccess'
        db.create_table('annotations_annotationtoolaccess', (
        ...
        db.send_create_signal('annotations', ['AnnotationToolAccess'])


    def backwards(self, orm):
        
        # Deleting model 'AnnotationToolAccess'
        db.delete_table('annotations_annotationtoolaccess')

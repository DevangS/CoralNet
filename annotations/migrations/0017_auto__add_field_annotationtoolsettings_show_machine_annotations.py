...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AnnotationToolSettings.show_machine_annotations'
        db.add_column('annotations_annotationtoolsettings', 'show_machine_annotations',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AnnotationToolSettings.show_machine_annotations'
        db.delete_column('annotations_annotationtoolsettings', 'show_machine_annotations')
    ...
    models = {
        ...
        'annotations.annotationtoolsettings': {
            ...
            'show_machine_annotations': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('annotations_label', 'description', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)

        # Adding field 'Label.thumbnail'
        db.add_column('annotations_label', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True), keep_default=False)

        # Adding field 'Label.create_date'
        db.add_column('annotations_label', 'create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

        # Adding field 'Label.created_by'
        db.add_column('annotations_label', 'created_by', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Label.description'
        db.delete_column('annotations_label', 'description')

        # Deleting field 'Label.thumbnail'
        db.delete_column('annotations_label', 'thumbnail')

        # Deleting field 'Label.create_date'
        db.delete_column('annotations_label', 'create_date')

        # Deleting field 'Label.created_by'
        db.delete_column('annotations_label', 'created_by_id')

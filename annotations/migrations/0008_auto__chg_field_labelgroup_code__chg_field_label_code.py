...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LabelGroup.code'
        db.alter_column('annotations_labelgroup', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))

        # Changing field 'Label.code'
        db.alter_column('annotations_label', 'code', self.gf('django.db.models.fields.CharField')(max_length=10))


    def backwards(self, orm):
        
        # Changing field 'LabelGroup.code'
        db.alter_column('annotations_labelgroup', 'code', self.gf('django.db.models.fields.CharField')(max_length=5))

...
function json = decodeSpecialChars(json)

json = regexprep(json, '_0x20_', ' ');
json = regexprep(json, '_0x28_', '(');
json = regexprep(json, '_0x29_', ')');

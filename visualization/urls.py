...
urlpatterns = patterns('',
    ...
    url(r'^(?P<source_id>\d+)/export/annotations', 'visualization.views.export_annotations', name="export_annotations"),
    url(r'^(?P<source_id>\d+)/export/statistics', 'visualization.views.export_statistics', name="export_statistics"),
)

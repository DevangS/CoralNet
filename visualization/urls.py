...
urlpatterns = patterns('',
    ...
    url(r'^(?P<source_id>\d+)/export_annotations', 'visualization.views.export_annotations', name="export_annotations"),
    url(r'^(?P<source_id>\d+)/export_statistics', 'visualization.views.export_statistics', name="export_statistics"),

...
urlpatterns = patterns('',
    ...
    url(r'^source/(?P<source_id>\d+)/csv/$', 'images.views.csv_download', name="csv_download"),
    url(r'^source/(?P<source_id>\d+)/(?P<robot_id>\d+)/(?P<namestr>[a-z]+)$', 'images.views.cm_download', name="cm_download"),

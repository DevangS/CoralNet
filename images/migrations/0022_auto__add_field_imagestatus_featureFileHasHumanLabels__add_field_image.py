...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ImageStatus.featureFileHasHumanLabels'
        db.add_column('images_imagestatus', 'featureFileHasHumanLabels', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ImageStatus.usedInCurrentModel'
        db.add_column('images_imagestatus', 'usedInCurrentModel', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ImageStatus.featureFileHasHumanLabels'
        db.delete_column('images_imagestatus', 'featureFileHasHumanLabels')

        # Deleting field 'ImageStatus.usedInCurrentModel'
        db.delete_column('images_imagestatus', 'usedInCurrentModel')

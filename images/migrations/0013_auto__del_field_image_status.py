...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        print (
            "-----\n"
            "Deleting the integer status field from the Image model."
            "\n-----"
        )

        # Deleting field 'Image.status'
        db.delete_column('images_image', 'status')
    ...
    def backwards(self, orm):
        ...
        print (
            "-----\n"
            "Adding back the integer status field to the Image model."
            "NOTE: This migration rollback won't restore integer image statuses.  "
            "Image statuses will be lost."
            "\n-----"
        )

        # Adding field 'Image.status'
        db.add_column('images_image', 'status', self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True), keep_default=False)

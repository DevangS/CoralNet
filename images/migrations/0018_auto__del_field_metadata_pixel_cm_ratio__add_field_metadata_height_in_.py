...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Metadata.pixel_cm_ratio'
        db.delete_column('images_metadata', 'pixel_cm_ratio')

        # Adding field 'Metadata.height_in_cm'
        db.add_column('images_metadata', 'height_in_cm', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'Source.image_height_in_cm'
        db.add_column('images_source', 'image_height_in_cm', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Metadata.pixel_cm_ratio'
        db.add_column('images_metadata', 'pixel_cm_ratio', self.gf('django.db.models.fields.CharField')(max_length=45, null=True, blank=True), keep_default=False)

        # Deleting field 'Metadata.height_in_cm'
        db.delete_column('images_metadata', 'height_in_cm')

        # Deleting field 'Source.image_height_in_cm'
        db.delete_column('images_source', 'image_height_in_cm')
    ...
    models = {
        ...
        'images.source': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image_height_in_cm': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),

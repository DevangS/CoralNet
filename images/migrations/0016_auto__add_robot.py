...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Robot'
        db.create_table('images_robot', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Source'])),
            ('version', self.gf('django.db.models.fields.IntegerField')(unique=True)),
            ('path_to_model', self.gf('django.db.models.fields.CharField')(max_length=500)),
            ('time_to_train', self.gf('django.db.models.fields.BigIntegerField')()),
            ('create_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('images', ['Robot'])


    def backwards(self, orm):
        
        # Deleting model 'Robot'
        db.delete_table('images_robot')

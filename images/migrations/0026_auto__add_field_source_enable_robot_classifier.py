...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.enable_robot_classifier'
        db.add_column('images_source', 'enable_robot_classifier', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Source.enable_robot_classifier'
        db.delete_column('images_source', 'enable_robot_classifier')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'SourceInvite'
        db.create_table('images_sourceinvite', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invites_sent', to=orm['auth.User'])),
            ('recipient', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invites_received', to=orm['auth.User'])),
            ('source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Source'])),
            ('source_perm', self.gf('django.db.models.fields.CharField')(max_length=50)),
        ))
        db.send_create_signal('images', ['SourceInvite'])

        # Adding unique constraint on 'SourceInvite', fields ['recipient', 'source']
        db.create_unique('images_sourceinvite', ['recipient_id', 'source_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'SourceInvite', fields ['recipient', 'source']
        db.delete_unique('images_sourceinvite', ['recipient_id', 'source_id'])

        # Deleting model 'SourceInvite'
        db.delete_table('images_sourceinvite')

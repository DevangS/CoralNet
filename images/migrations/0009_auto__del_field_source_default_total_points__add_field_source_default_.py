...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Source.default_point_generation_method'
        db.add_column('images_source', 'default_point_generation_method', self.gf('django.db.models.fields.CharField')(default='m_200', max_length=50), keep_default=False)

        # Deleting field 'Image.total_points'
        db.delete_column('images_image', 'total_points')

        # Adding field 'Image.point_generation_method'
        db.add_column('images_image', 'point_generation_method', self.gf('django.db.models.fields.CharField')(default='', max_length=50, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Source.default_total_points'
        db.add_column('images_source', 'default_total_points', self.gf('django.db.models.fields.IntegerField')(default=200), keep_default=False)

        # Deleting field 'Source.default_point_generation_method'
        db.delete_column('images_source', 'default_point_generation_method')

        # Adding field 'Image.total_points'
        db.add_column('images_image', 'total_points', self.gf('django.db.models.fields.IntegerField')(default=200), keep_default=False)

        # Deleting field 'Image.point_generation_method'
        db.delete_column('images_image', 'point_generation_method')

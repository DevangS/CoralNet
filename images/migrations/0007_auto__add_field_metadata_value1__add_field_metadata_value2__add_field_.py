...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Image.value4'
        db.delete_column('images_image', 'value4_id')

        # Deleting field 'Image.value5'
        db.delete_column('images_image', 'value5_id')

        # Deleting field 'Image.value3'
        db.delete_column('images_image', 'value3_id')

        # Deleting field 'Image.value2'
        db.delete_column('images_image', 'value2_id')

        # Deleting field 'Image.value1'
        db.delete_column('images_image', 'value1_id')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Image.value4'
        db.add_column('images_image', 'value4', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Value4'], null=True, blank=True), keep_default=False)

        # Adding field 'Image.value5'
        db.add_column('images_image', 'value5', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Value5'], null=True, blank=True), keep_default=False)

        # Adding field 'Image.value3'
        db.add_column('images_image', 'value3', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Value3'], null=True, blank=True), keep_default=False)

        # Adding field 'Image.value2'
        db.add_column('images_image', 'value2', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Value2'], null=True, blank=True), keep_default=False)

        # Adding field 'Image.value1'
        db.add_column('images_image', 'value1', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Value1'], null=True, blank=True), keep_default=False)

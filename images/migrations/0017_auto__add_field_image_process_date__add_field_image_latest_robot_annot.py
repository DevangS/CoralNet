...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Image.process_date'
        db.add_column('images_image', 'process_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Image.latest_robot_annotator'
        db.add_column('images_image', 'latest_robot_annotator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['images.Robot'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Image.process_date'
        db.delete_column('images_image', 'process_date')

        # Deleting field 'Image.latest_robot_annotator'
        db.delete_column('images_image', 'latest_robot_annotator_id')

...
var Layouts = {
    ...
    createLayout: function createLayout(layout, parentElement) {
        ...
        for (i = 0; i < layout.length; i++) {
            ...
            if (isLeaf) {
                childElement = document.getElementById(layoutSubtree);
            }
            else {
            ...
            if (sizeDict.hasOwnProperty(childElement.id)) {
                ...
                if (sizeEntry.type === 'pixel') {
                    ...
                    if (sizeEntry.direction === 'x') {
                        $(childElement).width(sizeEntry.size);
                        sizeAllocatedThisLevel += sizeEntry.size;
                        ...
                        $(childElement).height(sizeEntry.size);
                        sizeAllocatedThisLevel += sizeEntry.size;
                    }
                }
            ...
            if (sizeDict.hasOwnProperty(childElement.id)) {
                ...
                if (sizeEntry.type === 'percentage') {
                    ...
                    if (sizeEntry.direction === 'x') {
                        ...
                        sizeAllocatedThisLevel += parentWidth * (sizeEntry.size / 100);
                        ...
                        sizeAllocatedThisLevel += parentHeight * (sizeEntry.size / 100);
                    }
                }

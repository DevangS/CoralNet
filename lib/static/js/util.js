 ...
 */
util.addLoadEvent( function() {
    $(".tutorial-message").css("display", "none");
    var image = '<img id="tutorial-button" width=20 src="/static/img/question-mark-icon.png" />';
    $(".tutorial-message").before(image);

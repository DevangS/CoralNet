...
var util = {
    ...
    */
    ...
    /* Create a merged object (e.g. a set of options) out of two
     * objects: one specifying default values, and one specifying
     * custom values (custom values take precedence).
     */
    createOptions: function(defaultOptions, customOptions) {
        var options = {};
    ...
    */
    ...
    /*
    Shrink some text to fit within a container element.
    Based on: http://stackoverflow.com/a/4166237/859858
    */
    shrinkTextToFit: function($container) {
        var width = $container.width(),
            html = '<span style="white-space:nowrap"></span>',
            line = $container.wrapInner( html ).children()[ 0 ],
            currentFontSize = $container.css('font-size');
    ...
    */
    ...
    /*
    Returns the type of an object as a string.  More accurate than the
...
/* String endsWith function, similar to Python's endswith.
 *
 * Source: http://stackoverflow.com/a/2548133/859858
 */

 ...
 */
var tutorialMessageIdNum = 0;
util.addLoadEvent( function() {
    var $tutorialMessages = $(".tutorial-message");
    $tutorialMessages.css("display", "none");
    $tutorialMessages.each ( function() {
        var tutorialMessageId = "tutorial-message-" + tutorialMessageIdNum;
        var tutorialImageId = "tutorial-image-" + tutorialMessageIdNum;
        this.attr("id", tutorialMessageId);
        tutorialMessageIdNum = tutorialMessageIdNum + 1;
        var image = '<img style="display:inline" id=' + tutorialImageId +' width=20 src="/static/img/question-mark-icon.png" />';
        this.before(image);
        this.dialog({
            autoOpen: false,
            height: 240,
        ...
        tutorialImageId.bind("click", function() {
            this.dialog("open");
        });
    });
